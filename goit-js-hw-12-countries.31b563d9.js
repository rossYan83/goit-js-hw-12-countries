...
})({"bptrv":[function(require,module,exports,__globalThis) {
...
searchBox.addEventListener("input", (0, _lodashDebounceDefault.default)(onSearch, 500));
function onSearch(e) {
    ...
    fetch(`https://restcountries.com/v2/name/${query}`).then((res)=>{
        if (!res.ok) throw new Error();
        return res.json();
    }).then(handleResults).catch(()=>{
        result.innerHTML = "";
        (0, _coreDefault.default).alert({
...
},{"lodash.debounce":"irvaP","@pnotify/core":"fay4s","@parcel/transformer-js/src/esmodule-helpers.js":"auY7f"}],"irvaP":[function(require,module,exports,__globalThis) {
/**
...
},{}],"auY7f":[function(require,module,exports,__globalThis) {
...
},{}]},["bptrv","a0t4e"], "a0t4e", "parcelRequirec490", {})
