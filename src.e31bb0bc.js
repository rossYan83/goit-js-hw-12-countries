...
var _default = exports.default = refs;
...
exports.countryCardTemplate = countryCardTemplate;
exports.countryListTemplate = countryListTemplate;
function countryListTemplate(countries) {
  return countries.map(function (country) {
    return "\n      <li class=\"country-list-item\">\n        <img src=\"".concat(country.flag, "\" alt=\"").concat(country.name, " flag\" class=\"country-list-flag\" />\n        <span class=\"country-list-name\">").concat(country.name, "</span>\n      </li>\n    ");
  }).join('');
}
function countryCardTemplate(country) {
  ...
  return "\n    <div class=\"country-card\">\n      <div class=\"country-card-header\">\n        <img src=\"".concat(country.flag, "\" alt=\"").concat(country.name, " flag\" class=\"country-card-flag\" />\n        <h2 class=\"country-card-name\">").concat(country.name, "</h2>\n      </div>\n      <div class=\"country-card-info\">\n        <p><strong>\u0421\u0442\u043E\u043B\u0438\u0446\u044F:</strong> ").concat(country.capital || 'Н/Д', "</p>\n        <p><strong>\u041D\u0430\u0441\u0435\u043B\u0435\u043D\u043D\u044F:</strong> ").concat(country.population.toLocaleString('uk-UA'), "</p>\n        <p><strong>\u041C\u043E\u0432\u0438:</strong> ").concat(languages, "</p>\n      </div>\n    </div>\n  ");
}
...
_core.defaults.closer = true;
_core.defaults.sticker = false;
_refs.default.searchBox.addEventListener('input', (0, _lodash.default)(onSearch, 500));
function onSearch(event) {
  ...
  (0, _fetchCountries.default)(searchQuery).then(handleSearchResults).catch(handleSearchError);
}
...
function renderCountryList(countries) {
  var markup = "<ul class=\"country-list\">".concat((0, _templates.countryListTemplate)(countries), "</ul>");
  _refs.default.countryInfo.innerHTML = markup;
}
function renderCountryCard(country) {
  _refs.default.countryInfo.innerHTML = (0, _templates.countryCardTemplate)(country);
}
function clearCountryInfo() {
  _refs.default.countryInfo.innerHTML = '';
}
